...
public class ControllerFragment extends ConnectedPeripheralFragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, SensorEventListener, ControllerColorPickerFragment.ControllerColorPickerFragmentListener, ControllerPadFragment.ControllerPadFragmentListener, CarController.CarControllerListener,  UartDataManager.UartDataManagerListener {
    // Log
    ...
    private static final int kModule_Car = 2;
    private static final int kNumModules = 3;
                    ...
                    if (activity != null) {
                        ...
                        switch (moduleId) {
                            ...
                            case kModule_ColorPicker:
                                ...
                                break;
                            case kModule_Car:
                                fragment = CarController.newInstance();
                                fragmentTag = "CarController";
                                break;
                        }
    ...
    private static class ControllerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private static final int[] kModuleTitleKeys = {R.string.controller_module_pad, R.string.controller_module_colorpicker, R.string.controller_module_car};
    ...
    @Override
    public void onSendCarCommand(int tag, int value) {
        //String data = "!B" + tag + (isPressed ? "1" : "0");
        //String data = "" + tag + (value ? "1" : "0");
